...
class AsteroidListAdapter(private val clickListener: AsteroidListClickListener) : ListAdapter<Asteroid,
    ...
    class ViewHolder private constructor(private val binding: ListItemAsteroidBinding) :
        ...
        fun bind(clickListener: AsteroidListClickListener, item: Asteroid) {
...
class AsteroidListClickListener(val clickListener: (selectedAsteroid: Asteroid) -> Unit) {
